...
class CreateSalesInvoiceBillingAddressTable extends Migration
{
    public function up()
    {
        Schema::create('sales_invoice_billing_address', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sales_invoice_billing_address');
    }
}