...
class CreateSalesOrderBillingAddressTable extends Migration
{
    public function up()
    {
        Schema::create('sales_order_billing_address', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sales_order_billing_address');
    }
}