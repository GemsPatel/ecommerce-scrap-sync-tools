...
class CreateDscoBpShipmentShippingAddressTable extends Migration
{
    public function up()
    {
        Schema::create('dsco_bp_shipment_shipping_address', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dsco_bp_shipment_shipping_address');
    }
}